...
def validate_integer(
    ...
    min_value: int = None,
    max_value: int = None,
    custom_min_message: str = None,
    custom_max_message: str = None,
):
    ...
    Args:
        arg_name: the name of the argument (used in default error messages)
        arg_value: the value being validated
        min_value: optional, specifies the minimum value (inclusive)
        max_value: optional, specifies the maximum value (inclusive)
        custom_min_message: optional, custom message when value is less
            than minimum
        custom_max_message: optional, custom message when value is greater
            than maximum
